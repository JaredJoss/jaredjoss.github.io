...
const Footer = () => {
  ...
  return (
    <footer className="absolute bottom-16 sm:bottom-0 left-0 sm:left-[10%] right-0 sm:right-[10%] px-4 sm:px-8 py-3 sm:py-6 flex flex-row justify-between items-end gap-2 sm:gap-0 text-xs sm:text-sm">
